...
import { searchFields as nodeSearchFields } from 'global-admin/components/node-dots/component';
...
export default Controller.extend({
  ...
  extraSearchSubFields: nodeSearchFields,
  sortBy:               'name',
  searchText:           null,
  bulkActions:          true,
  ...
  actions: {
    ...
    toggleExpand(instId) {
      const list = this.expandedInstances;
